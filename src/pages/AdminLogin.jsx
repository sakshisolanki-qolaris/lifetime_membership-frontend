...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "लॉगिन विफल (Login failed).",
      );
    } finally {
      setLoading(false);
    }
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-gray-50/50">
          <div>
            ...
            <div className="relative">
              ...
              <input
                id="phone" /* Fixed: Added matching id */
                type="text"
                name="phone"
                required
          ...
          <div>
            ...
            <div className="relative">
              <input
                id="password" /* Fixed: Added matching id */
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex items-center pr-3 pb-7 text-gray-500 hover:text-gray-700 focus:outline-none"
