    ...
    try {
      ...
      toast.error(
        error.response?.data?.message ||
          "पासवर्ड बदलने में विफल (Failed to change password).",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-gray-800">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            ...
            <input
              id="currentPassword" /* Fixed: Added matching id */
              type="password"
          ...
          <div>
            ...
            <input
              id="confirmPassword" /* Fixed: Added matching id */
              type="password"
          ...
          >
            {loading
              ? "अपडेट हो रहा है..."
              : "पासवर्ड सुरक्षित करें (Save Password)"}
          </button>
        </form>
      </div>
    </div>
